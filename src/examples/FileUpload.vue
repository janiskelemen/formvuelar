...
<template>
  <div class="mb-16">
    ...
    <fvl-form :data="form" url="/upload" multipart class="relative">
      ...
      <fvl-file v-model:file="form.file" label="File" name="file">
        <template #button>
    ...
    <fvl-form :data="form" url="/upload" multipart class="relative">
      ...
      <!-- File input component -->
      <fvl-image v-model:file="form.avatar" label="Avatar" name="avatar"></fvl-image>
